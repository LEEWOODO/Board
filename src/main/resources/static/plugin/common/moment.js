...
;(function (global, factory) {
    ...
    var match1 = /\d/, // 0 - 9
        ...
        matchShortOffset = /Z|[+-]\d\d(?::?\d\d)?/gi, // +00 -00 +00:00 -00:00
														// +0000 -0000 or Z
        matchTimestamp = /[+-]?\d+(\.\d{1,3})?/, // 123456789 123456789.123
        // any word (or two) characters or numbers including two/three word
		// month in arabic.
    ...
    var defaultLocaleMeridiemParse = /[ap]\.?m?\.?/i,
        ...
        // specified which hour they want. So trying to maintain the same hour
		// (in
    ...
    function loadLocale(name) {
        ...
        if (
            ...
            try {
                ...
                // mark as not found to avoid repeating expensive file require
				// call causing high CPU
    ...
    function checkWeekday(weekdayStr, parsedInput, config) {
        if (weekdayStr) {
            // TODO: Replace the vanilla JS Date object with an independent
			// day-of-week check.
    ...
    // date from 1) ASP.NET, 2) ISO, 3) RFC 2822 formats, or 4) optional
	// fallback if parsing isn't strict
    ...
    var aspNetRegex = /^(-|\+)?(?:(\d*)[. ])?(\d+):(\d+)(?::(\d+)(\.\d*)?)?$/,
		...
		// anywhere
        // and further modified to allow for strings containing both week and
		// day
    ...
    // type MomentInput = Moment | Date | string | number | (number | string)[]
	// | MomentInputObject | void; // null | undefined
    ...
    function monthDiff(a, b) {
        if (a.date() < b.date()) {
            // end-of-month calculations work correct when the start month has
			// more
